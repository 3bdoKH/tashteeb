    ...
    const offers = [
        {
            ...
            subtitle: "مقدم يبدأ من 25% فقط وباقي المبلغ على 30 شهر بدون فوائد ✨",
            details: [
                {
                    title: "💰 نظام السداد:",
                    items: [
                        ...
                        "الباقي (60%): يُقسّم على 30 شهر بدون فوائد."
                    ]
                },
                {
                    title: "🛠 خطوات التنفيذ:",
        ...
        },
        {
            ...
            subtitle: "مقدم 25% فقط والباقي بالتقسيط على 30 شهر بدون فوائد",
            details: [
                {
                    title: "✅ أسعار الباقات:",
                    items: [
                ...
                },
                {
                    title: "📌 أنظمة السداد:",
                    items: [
                        "استلام خلال 6 شهور: 25% مقدم + 10% بعد شهرين + الباقي على 30 شهر.",
                        "استلام خلال 4 شهور: 25% مقدم + 20% بعد شهرين + الباقي على 30 شهر."
                    ]
                },
                {
                    title: "🛠 التشطيب يشمل:",
